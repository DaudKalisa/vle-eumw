            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-header py-3" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                        <h4 class="mb-0 text-white"><i class="bi bi-pencil me-2"></i>Edit Course</h4>
                    </div>
                    <div class="card-body">
                        <?php if (isset($error)): ?>
                        ...
                        <form method="POST">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i>Update Course</button>
                        </form>
                    </div>
                </div>
            </div>
