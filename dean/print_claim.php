<?php
/**
 * Dean Portal - Print Lecturer Claim
 * Matches finance/print_lecturer_payment.php receipt design
 * Includes dean approval modal with signature draw/upload
 */
...
// Reference number
$ref_number = 'DEAN/CLM/' . date('Y') . '/' . str_pad($request_id, 5, '0', STR_PAD_LEFT);
...
<body>
                    ...
                    <table class="info-table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <span class="badge bg-secondary"><?= ucfirst($claim['dean_approval_status'] ?? 'Pending') ?></span>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title">Dean of Faculty Approval</h5>
    ...
    function submitApproval() {
        ...
        fetch('submit_approval.php', {
            ...
            body: JSON.stringify({ request_id: document.getElementById('requestId').value, role: 'dean', signature: sig, remarks: document.getElementById('approvalRemarks').value })
