    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="studentNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link<?php if(basename($_SERVER['PHP_SELF'])=='resources.php')echo' active'; ?>" href="<?= $_student_base ?>resources.php"><i class="bi bi-folder2-open me-1"></i>Resources</a></li>
