<?php
/**
 * Student Dissertation Guidelines
 * Full content view of all dissertation guidelines organized by phase
 */
session_start();
...
$breadcrumbs = [
    ['title' => 'Dissertation', 'url' => 'dissertation.php'],
    ['title' => 'Guidelines']
];
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Dissertation Guidelines - VLE</title>
    ...
    <style>
        ...
        .phase-header .badge { font-size: 0.7rem; }
        .guideline-item { padding: 1rem 1.25rem; border-top: 1px solid #f1f5f9; }
        .guideline-item:last-child { border-radius: 0 0 8px 8px; }
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body p-2" style="max-height: calc(100vh - 200px); overflow-y: auto;">
                        ...
                        <div class="d-grid gap-1 px-1">
                            ...
                            <a href="dissertation.php" class="btn btn-sm btn-outline-primary">
                                <i class="bi bi-arrow-left me-1"></i>Back to Dissertation
                            </a>
                            <button onclick="window.print()" class="btn btn-sm btn-outline-secondary">
                                <i class="bi bi-printer me-1"></i>Print Guidelines
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Complete reference guide for your dissertation — from topic selection to final submission.</p>
                </div>
                <div class="d-flex gap-2 no-print">
                    <a href="guidelinebook.php" class="btn btn-primary">
                        <i class="bi bi-journal-richtext me-1"></i>Read Full Guideline Book
                    </a>
                    <a href="dissertation.php" class="btn btn-outline-primary">
                        <i class="bi bi-arrow-left me-1"></i>My Dissertation
                    </a>
                </div>
            </div>
            ...
            <?php if (empty($all_guidelines)): ?>
                <div class="alert alert-info text-center py-5">
                    ...
                    <p class="mt-2 mb-0">No guidelines have been published yet. Please check back later.</p>
                </div>
            <?php else: ?>
                <?php foreach ($phase_order as $phase_key): ?>
